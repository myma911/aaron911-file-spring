...
public class MinIoApi {
    ...
    public MinIoApi(String endpoint, String accessKeyId, String accessKeySecret) throws MinIoApiException {
        try {
     ...
     * @throws InvalidKeyException 
     */
    public boolean isExistFile(String bucketName, String objectName) throws InvalidKeyException, ErrorResponseException, IllegalArgumentException, InsufficientDataException, InternalException, InvalidBucketNameException, InvalidResponseException, NoSuchAlgorithmException, XmlParserException, IOException, MinIoApiException {
        try {
